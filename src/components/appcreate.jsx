        ...
        <>
            ...
            <Container id="AppCreateContainer">
                ...
                <div id="toggleContainer" style={{ display: 'flex', justifyContent: 'center' , marginBottom: '10%' }}>
                    <Button color="secondary" variant={isLinkUpload ? 'contained' : 'contained'} sx={{  border: "0px" , marginRight: "0px" ,borderRadius: "0px" ,color:"black"}} onClick={() => setIsLinkUpload(true)} className={isLinkUpload ? 'outlined-button' : 'outlined-button2'} >Link Upload</Button>
                    <Button color="secondary" variant={!isLinkUpload ? 'contained' : 'contained'} sx={{  border: "0px" , marginRight: "0px" ,borderRadius: "0px" ,color:"black"}} onClick={() => setIsLinkUpload(false)} className={!isLinkUpload ? 'outlined-button' : 'outlined-button2'}>File Upload</Button>
                </div>
                </Box>
                {isLinkUpload ? (
                <Box id="AppCreateTextInput">
                    <Grid>
                        ...
                        value={nameValue} onChange={onChangeName} className='outlinetextbar' style={{ paddingTop: "5px", paddingLeft: '20px', color:'white',}} />
                    </Grid>
                    <Grid>
                        <p>Registry:</p>
                        <TextField
                        ...
                        value={registryValue} onChange={onChangeRegistry} className='outlinetextbar' style={{ paddingTop: "5px", paddingBottom: "30px", paddingLeft: '8px', color:'white',}} />
                    </Grid>
                    <Button variant='contained' color="secondary" onClick={CreateAppfun} style={{ background:"#fc3",color:"#121212" }}>
                        Submit
                    </Button>
                </Box>
                ) : (
                <Box id="AppCreateDropInput">
                    <Grid>
                        <p style={{ width: "50px" }}>Name:</p>
                        {/* <TextField variant='outlined' sx ={{  '&:hover fieldset': { borderColor: 'yellow',},'& .MuiInputBase-input': { color: 'white', },'& .MuiFocused':{color:'#fc3'},'& .MuiOutlinedInput-root': {'& fieldset': {  borderColor: '#fc3',},'&:hover fieldset': { borderColor: '#fc3',},'&:not{:hover} fieldset': { borderColor: '#fc3',} ,'&:focus fieldset': { borderColor: '#fc3',},'&:not{:focus} fieldset': { borderColor: '#fc3',},},}} */}
                        <TextField
                        variant='outlined'
                        sx={{
                          '&:hover fieldset': {
                        ...
                        value={nameValue} onChange={onChangeName} style={{ paddingTop: "5px", paddingLeft: '10px', color:'white',}} />
                    </Grid>
                    <br></br>
                    

                    <Box id="AppCreateDropBox" sx={{backgroundColor:"#1A1C1F"}}>
                        <DropFileInput sx={{backgroundColor:"#1A1C1F" ,color:"white"}} onFileChange={(files) => handleFileChange(files)} />
                        <br></br>
                        <Box sx={{ width: '80%'}}>
                            <LinearProgressWithLabel value={progress} />
                        </Box>
                        <br></br>
                        <Button variant='contained' color="secondary" sx={{background:"#fc3",color:"#121212"}} onClick={starterFunction}  >
                        {/* {isLoading ? (
                            <>
